...
import Howtoplay from '../../../src/components/SplashScreen/How-to-play';
...
const TabModal = () => {
    ...
    return (
        <Fragment>
            ...
            <button type="button" class="btn btn-lg btn-pink w-100 my-1" onClick={() => setModal({ open: true, tab: 'HOW_TO_PLAY' })}>How To Play</button>
            <div class="d-flex">
