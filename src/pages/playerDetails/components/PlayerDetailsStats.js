    ...
    return(
        ...
        <div className="body">
                <div className="px-1 pb-2" style={{marginTop: '-25px'}}>
                    <div className="p-2" style={{'background':'#E7155D', 'color': 'white', 'borderRadius': '5px'}}>Apperance: <b>23</b></div>
                    ...
                    {sortableByValue.map(data=>{
                        ...
                        {/* <li>
                            <div className="d-flex">
                                <span className="mr-auto">{sortable[1].slice(0,1)}</span>
                                <span>{sortable[1].slice(1,2)}</span>
                            </div>
                            <div className="progress">
                                <div className="progress-bar progress-bar-purple" role="progressbar" aria-valuenow="40" 
