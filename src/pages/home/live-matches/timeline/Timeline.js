...
getComments=()=>{
    ...
    this.props.timelines.forEach(element => {
    ...
    render() {
        ...
        return (
            ...
            <div className={this.props.scrolled ? "tab-content scrolledHeight" : "tab-content"}>
                {!isLoading && !Boolean(Object.keys(timeline).length) &&
                ...
                {isLoading && !Boolean(Object.keys(timeline).length) && <tbody>
                    <tr>
                        <td colspan="2"
                            style={{
                                fontSize: '25px',
                ...
                <div role="tabpanel" class="tab-pane active" id="timeline" style={{ marginBottom: "20px" }}>
                    {!!timeline && timeline.map((data, index) => {
                            ...
                            data.event !== "GOAL" ?
                                ...
                                <div class="row activity" >
                                    ...
                                    <div class="col-xs-10">
                                        ...
                                        <div class="green">
                                            {data.commenttext.length <= 130 ? (
                                                <div class="msg" style={{ background: "#DBFFB9" }}>
