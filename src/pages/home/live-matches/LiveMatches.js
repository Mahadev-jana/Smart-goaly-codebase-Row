                        ...
                        <div class="mid">
                            <div style={{ minHeight: 300, backgroundColor: '#fff' }} >
                                <div style={{ backgroundColor: '#fff', height: 'auto' }}>
                                    {((loading && matches.length == 0) || (loading && news.length == 0)) && <div style={{ position: 'absolute', top: '50%', left: '45%' }}><img src={loader} style={{ height: '40px', marginTop: '40%' }} /></div>}
                                    ...
                                    {!loading && tab == "news" && news.length >= 1 && <Grid className="batbat" style={{ height: 360, overflow: 'scroll', overflowX: 'hidden' }}>
                                        <Row class="part" style={{ marginBottom: '40px' }}>
                                            <Col xs={12} className="lm mt-10" style={{ fontWeight: '600', color: 'black', textAlign: 'center', height: 360 }}>
