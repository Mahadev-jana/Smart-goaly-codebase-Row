...
class TeamDetails extends React.Component {
    ...
    callbackFunction = (logo, name, venue, city, league, country,league_logo,country_logo) => {

        this.setState({ logo, name, venue, city, league, country,league_logo,country_logo })
    }
    componentDidMount() {
    ...
    loginPage = () => {
        // Swal.fire({
        //     type: 'error',
        //     title: 'Subscribe first to follow your favorite clubs!!',
    ...
    getFavTeam = () => {
        ...
        axios.post('/clubTeam', payload).then(res => {
            if (res.data && res.data.success && res.data.success == 1) {
    ...
    render() {
        ...
        // console.log(this.state.newsForTeam)
        ...
        return (
            <React.Fragment>
                ...
                <div>
                    ...
                    <Modal open={this.state.open} onClose={this.onCloseModal} center><NonCellularDataPopUup onClose={this.onCloseModal} /></Modal>
