                                                        ...
                                                        return <tr>
                                                            <td width="35%" className="text-spec">
                                                                <div className="col-xs-6 pd-0">
                                                                    <p className="">
                                                                        <img src={homeTeam_logo} style={{ height: 15, width: 11, margin: 1 }} alt="" />
                                                                        <strong style={{ marginLeft: 5 }}>{homeTeam_name}</strong>
                                                                    </p>
                                                                    <p className="">
                                                                        <img src={awayTeam_logo} style={{ height: 15, width: 11, margin: 1 }} alt="" />
                                                                        <strong style={{ marginLeft: 5 }}>{awayTeam_name}</strong>
                                                                    </p>
                                                                </div>
                                                                <div className="col-xs-6">
                                                                    <p className="text-left" style={{paddingTop:'15px',textAlign:'right'}}>{pred.homeTeam.score}</p>
                                                                    <p className="text-left" style={{paddingTop:'15px',textAlign:'right'}}>{pred.awayTeam.score}</p>
                                                                </div>
                                                            </td>
