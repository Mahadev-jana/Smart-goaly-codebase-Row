...
class CellularWithMsisdnDataPopUp extends Component {
    constructor(props) {
        super(props);
        this.state = {
            info: {},
    ...
    weeklySubscribe=()=>{
        ...
        payload.append('mobile_data', true);
        axios({
            method: 'post',
    ...
    dailySubscribe=()=>{
        ...
        axios({
            method: 'post',
            url: 'http://staging.smartcms.goaly.mobi/Api/subscription',
                    ...
                    <div className="modal-content w-100" style={{ background: 'white' }}>
                        ...
                        <div id="otp-flow" className="slide" data-tag="otp-flow" style={{ display: 'block', padding: '15px' }}>
                            <div className="input-control active" number>
                                <h5 className="mb-2 w-100">Your MSISDN is: <span><b>{info.msisdn}</b></span></h5>
                                {/* <div className="d-flex">
                                    <span className="form-control w-max-c mr-1">+62</span>
                                    <input className="form-control" type="text" />
                                    
                                </div> */}
                                <button className="btn btn-success send-number w-100 mt-1" style={{ backgroundColor: "#7cd327" }} onClick={this.dailySubscribe}><b>DAILY</b></button>
                                <button className="btn btn-success send-number w-100 mt-1" style={{ backgroundColor: ' rgb(39, 108, 211)' }} onClick={this.weeklySubscribe}><b>WEEKLY</b></button>
...
export default CellularWithMsisdnDataPopUp;