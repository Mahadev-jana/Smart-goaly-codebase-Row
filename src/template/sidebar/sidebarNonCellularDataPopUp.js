...
class cellularDataPopUup extends Component {
    ...
    checkMsisdn=()=>{
        ...
        if (this.state.msisdn.length===0) {
            ...
            payload.append('msisdn', this.removeLeadingZero(this.state.msisdn));
            axios.post('checkMsisdnStatus', payload)
                .then(res => {
                    ...
                    if(res.data.status==='active'){
                        ...
                        axios.post('smartlogin', payload)
                            .then(res => {
                                ...
                                localStorage.setItem('msidnByUser',  this.removeLeadingZero(this.state.msisdn));
    ...
    updateInput =(e) =>{
        ...
        console.log(typeof(this.state.msisdn));
    }
    onOpenModal = () => {
    ...
    render() {
        ...
        return (
            ...
            <div>
                <InactiveNewMemberPopup onClose={this.props.onClose} msisdn={this.state.msisdn}/>
            </div>
                    ...
                    <div className="modal-content w-100" style={{ background: 'white' }}>
                        ...
                        <div id="otp-flow" className="slide" data-tag="otp-flow" style={{ display: 'block', padding: '15px' }}>
                            ...
                            {this.state.loading && <Loader title="Please Wait"/>}
                                ...
                                <button className="btn btn-success send-number w-100 mt-1" style={{ backgroundColor: "#0F7B30" }} onClick={this.checkMsisdn}><b>SEND</b></button>
